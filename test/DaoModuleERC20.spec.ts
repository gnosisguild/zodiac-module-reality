...
describe("DaoModuleERC20", async () => {
    ...
    describe("addProposalWithNonce", async () => {
        it("throws if previous nonce was not invalid", async () => {
            ...
            await mock.givenMethodReturnUint(oracle.interface.getSighash("askQuestionWithMinBondERC20"), previousQuestionId)
            await module.addProposal(id, [txHash])
        ...
        it("can invalidate multiple times", async () => {
            ...
            await mock.givenMethodReturnUint(oracle.interface.getSighash("askQuestionWithMinBondERC20"), finalQuestionId)
        ...
        it("does not create proposal if previous nonce was internally invalidated", async () => {
            ...
            await mock.givenMethodReturnUint(oracle.interface.getSighash("askQuestionWithMinBondERC20"), questionIdNonce0)
            ...
            await mock.givenMethodReturnUint(oracle.interface.getSighash("askQuestionWithMinBondERC20"), questionIdNonce1)
            await expect(
