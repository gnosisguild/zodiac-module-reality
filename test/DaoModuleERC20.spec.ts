...
describe('RealityModuleERC20', async () => {
  ...
  describe('setQuestionCooldown', async () => {
    it('throws if Ownable: caller is not the owner', async () => {
      const { module } = await setupTestWithTestAvatar()
      await expect(module.setQuestionCooldown(2)).to.be.revertedWithCustomError(
        module,
        'OwnableUnauthorizedAccount',
      )
    })
  ...
  describe('setAnswerExpiration', async () => {
    it('throws if Ownable: caller is not the owner', async () => {
      const { module } = await setupTestWithTestAvatar()
      await expect(module.setAnswerExpiration(2)).to.be.revertedWithCustomError(
        module,
        'OwnableUnauthorizedAccount',
      )
    })
  ...
  describe('setArbitrator', async () => {
    it('throws if Ownable: caller is not the owner', async () => {
      const { module } = await setupTestWithTestAvatar()
      await expect(
        module.setArbitrator(ethers.ZeroAddress),
    ...
    it('updates arbitrator', async () => {
      ...
      expect(await module.questionArbitrator()).to.be.equals(ethers.ZeroAddress)
    })
  })
  ...
  describe('setTemplate', async () => {
    ...
    it('updates template', async () => {
      ...
      expect(await module.template()).to.be.equals(1337)
      ...
      expect(await module.template()).to.be.equals(112358)
    })
  })
  ...
  describe('markProposalAsInvalidByHash', async () => {
    ...
    it('marks known question id as invalid', async () => {
      ...
      await mock.givenMethodReturnUint(
        oracle.interface.getFunction('askQuestionWithMinBondERC20').selector,
        questionId,
      )
  ...
  describe('addProposal', async () => {
    ...
    it('calls askQuestionWithMinBondERC20 with correct data', async () => {
      ...
      const askQuestionCalldata = oracle.interface.encodeFunctionData(
        'askQuestionWithMinBondERC20',
        [1337, question, await mock.getAddress(), 42, 0, 0, 0, 0],
      )
      expect(
        Number(
      ...
      expect(await mock.invocationCount.staticCall()).to.be.equals(1)
    })
  })
  ...
  it('calls askQuestionWithMinBondERC20 with correct data when minimum bond is set', async () => {
    ...
    const askQuestionCalldata = oracle.interface.encodeFunctionData(
      'askQuestionWithMinBondERC20',
      [1337, question, await mock.getAddress(), 42, 0, 0, 7331, 0],
    )
    expect(
      Number(
        await mock.invocationCountForCalldata.staticCall(askQuestionCalldata),
  ...
  describe('addProposalWithNonce', async () => {
    ...
    it('calls askQuestionWithMinBondERC20 with correct data', async () => {
      ...
      const askQuestionCalldata = oracle.interface.encodeFunctionData(
        'askQuestionWithMinBondERC20',
        [1337, question, await mock.getAddress(), 42, 0, 1, 0, 0],
      )
      expect(
        Number(
          await mock.invocationCountForCalldata.staticCall(askQuestionCalldata),
      ...
      expect(await mock.invocationCount.staticCall()).to.be.equals(2)
    })
    ...
    it('can invalidate after question param change', async () => {
      ...
      const askQuestionCalldata = oracle.interface.encodeFunctionData(
        'askQuestionWithMinBondERC20',
        [1337, question, await mock.getAddress(), 23, 0, 11, 0, 0],
      )
      expect(
        Number(
          await mock.invocationCountForCalldata.staticCall(askQuestionCalldata),
    ...
    it('can invalidate multiple times', async () => {
      ...
      const askQuestionCalldata = oracle.interface.encodeFunctionData(
        'askQuestionWithMinBondERC20',
        [1337, question, await mock.getAddress(), 42, 0, 1337, 0, 0],
      )
      expect(
        Number(
          await mock.invocationCountForCalldata.staticCall(askQuestionCalldata),
      ...
      expect(await mock.invocationCount.staticCall()).to.be.equals(3)
    })
  ...
  describe('executeProposal', async () => {
    ...
    it('throws if answer expired', async () => {
      ...
      expect(await mock.invocationCount.staticCall()).to.be.equals(1)
      expect(
        await hre.ethers.provider.getBalance(await mock.getAddress()),
      ).to.be.equals(0)
